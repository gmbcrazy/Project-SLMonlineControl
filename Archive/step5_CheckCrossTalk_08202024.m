...
clear all
ProcessFolder='F:\LuSLMOnlineTest\SL0242-Ai203\08202024\';
...
gplFile='F:\LuSLMOnlineTest\SL0242-Ai203\08202024\GPLall.gpl';
...
PlanI=find(Z(:,2)==iplane);
plotCellCenter(MP3D(PlanI,[2 1]), 6, [0 1 0],1)
% labelCellCenter(MP3D(PlanI,[2 1]), MPName(PlanI),[0 1 0]);

...
[NeuronPos3D,NeuronPos3DRaw,CaData,CaDataPlane,stat,yaml]=Suite2pMultiPlaneROIToXYZ(DataFolder,2);
...
for jCell=1:length(SLMtarget)
    ...
    if iCell<0
       SLMTable(end+1,:) =  [Point(jCell) 0 0 0 1 length(I3) PreSLMFrameN PostSLMFrameN 0 0 0];
       continue;
    end
    figure;
% for iRep=2:2

...
RefFile=['E:\LuSLMOnlineTest\SL0855-Emx1G6CII-AAV9CAMKII\02262025\RegRef2Ch1Ch2\'];
numGPUs=0
[RegOps, RegImg] = LoadRegRefFile(RefFile, FileType,numGPUs);
RegImg=RegImg(:,:,1:3);


H=MultiPlanes2DShow(RegImg, cellBoundary, Pos3D, Pos3Dlabel, Zdepth, colorCell, ImgClim,varargin)

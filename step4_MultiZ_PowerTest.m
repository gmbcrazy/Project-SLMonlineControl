...
WorkingFolder='E:\LuSLMOnlineTest\SL0840-Ai203\02192025\'
...
ProcessFolder=[WorkingFolder 'SingleP\' 'Top38SpeedStimEdgeExc\'];
...
XMLparam.PointList=[12 14 16 26 27 34 36 38 41 42];
% XMLparam.Laser(1:10)=repmat(1.45,1,10);

clear all
ProcessFolder='F:\LuSLMOnlineTest\SL0342\05172024\TSeries\1-34\';
...
labelCellCenter(Pos3D, 1:size(Pos3D,1))
    papersizePX=[0 0 15 25];
    set(gcf, 'PaperUnits', 'centimeters');
    set(gcf,'PaperPosition',papersizePX,'PaperSize',papersizePX(3:4));
    saveas(gcf,[ResultFolder '3DSuite2pLayer'],'png');
    saveas(gcf,[ResultFolder '3DSuite2pLayer'],'fig');
...
labelCellCenter(Pos3D(I,[2 1]), CellID(I));
    ...
    papersizePX=[0 0 22 7];

    set(gcf, 'PaperUnits', 'centimeters');
    set(gcf,'PaperPosition',papersizePX,'PaperSize',papersizePX(3:4));
    saveas(gcf,[ResultFolder '2DSuite2pLayer'],'png');
    saveas(gcf,[ResultFolder '2DSuite2pLayer'],'fig');

...
% clear all
% 
% path='F:\LuSLMOnlineTest\SL0336\06062024\';
% DestiFolder='F:\LuSLMOnlineTest\SL0336\06062024\Ch2\';
% Folder='TSeries';
% NeedFile='tif';
% keyWord='Ch2';
...
clear all
ProcessFolder='F:\LuSLMOnlineTest\SL0336\06062024\Ch2\TSeries\PowerLevel3\';
...
SessInfoPath='F:\LuSLMOnlineTest\SL0336\06062024\';
...
% view(0, 90);
yaml.Zdepth_ETL=[-35 2 43]
figure;
for iplane=1:length(yaml.Zdepth_ETL)
subplot(1,3,iplane)
imagesc(Img(:,:,iplane)');
I=find(abs(Pos3D(:,3)-yaml.Zdepth_ETL(iplane))<4);
CellID=1:size(Pos3D,1);
% plotCellBoundary(cellBoundary(I), CellID(I))
colormap(gray);
caxis(MeanImgClim);
...
SLMCellID=[2 245 724 540]  %Level1 for P1,2,3,4
SLMCellID=[179 216 532]  %Level2 for P1 2 4
SLMCellID=[65 291 660]  %Level3 for P1 2 4

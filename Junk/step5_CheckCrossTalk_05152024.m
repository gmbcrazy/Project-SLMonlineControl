clear all
ProcessFolder='F:\LuSLMOnlineTest\SL0342\05152024\TSeries\';
...
SessInfo=readtable('F:\LuSLMOnlineTest\SL0342\05152024\SessionInfo.xlsx')
[~,I1,I2]=intersect(Session,SessInfo.Session);
SessInfoNeed=SessInfo(I2,:);
LastFrame=4500+cumsum([SessInfoNeed.TotalRepetition]);
FirstFrame=[4501;LastFrame(1:end-1)+1];



Fall=load('F:\LuSLMOnlineTest\SL0342\05152024\TSeries\suite2p\combined\Fall.mat');
        ...
        TempData=AmpNormalize(TempData,[0 100]);
            ...
            % for iLaser=1:8
                ...
                if LaserG(iLaser)==0
                   ...
                   I2=find(SessInfoNeed.Power==LaserG(iLaser)&SessInfoNeed.Point==jCell);

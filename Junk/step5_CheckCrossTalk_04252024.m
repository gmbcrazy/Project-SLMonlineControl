clear all
ProcessFolder='F:\LuSLMOnlineTest\MouseMei03\04252024\SingleP\20PixelFromEdgeExc\Data\';
ProcessFolder='F:\LuSLMOnlineTest\MouseMei03\04252024\SingleP\20PixelFromEdgeExc\DataDelete1Frame\';
...
FrameNum=[4500;ones(length(TiffFolder)-1,1)*70];
FrameNum=[4500;ones(length(TiffFolder)-1,1)*69];    %%For deleting the 1st frame data, with missing data; Not the 001 file of 4500 repetitions.

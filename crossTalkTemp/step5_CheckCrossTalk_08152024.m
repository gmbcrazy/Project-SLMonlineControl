...
clear all
ProcessFolder='F:\LuSLMOnlineTest\SL0242-Ai203\08152024\';
...
SessInfoPath='F:\LuSLMOnlineTest\SL0242-Ai203\08152024\';
SessInfo=readtable([SessInfoPath 'SessionInfo.xlsx'])
[~,I1,I2]=intersect(Session,SessInfo.Session);
SessInfoNeed=SessInfo(I2,:);
LastFrame=cumsum([SessInfoNeed.TotalRepetition])+2500;
FirstFrame=[2501;LastFrame(1:end-1)+1];
...
SLMCellID=[15 47 1 62 52 54 129 118 123]  %Level4

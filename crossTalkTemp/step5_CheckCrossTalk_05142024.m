clear all
ProcessFolder='F:\LuSLMOnlineTest\MouseMei03\05142024\SingleP\20PixelFromEdgeExc\Data\';
...
SessInfo=readtable('F:\LuSLMOnlineTest\MouseMei03\05142024\Session_Summary.xlsx')
...
SLMtarget=load('F:\LuSLMOnlineTest\MouseMei03\05142024\SingleP\EdgeExc\SLMIncludedIndFromIscell.mat')

Fall=load('F:\LuSLMOnlineTest\MouseMei03\05142024\SingleP\20PixelFromEdgeExc\Data\suite2p\combined\Fall.mat');
...
TPoint = [1 3 6 9 11];
SLMCellID=[7 6 13 20 19];


SessInfoNeed.Power(SessInfoNeed.Power>0)=400;
        ...
        TempData=AmpNormalize(TempData,[0 100]);
            ...
            % for iLaser=1:8
                ...
                if LaserG(iLaser)==0
                   ...
                   I2=find(SessInfoNeed.Power==LaserG(iLaser)&SessInfoNeed.Point==TPoint(jCell));

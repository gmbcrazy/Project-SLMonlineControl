#library(R.matlab)
library(lmerTest)
dataTable=read.csv("//nimhlabstore1.nimh.nih.gov/UFNC/FNC2/Zhang/Projects/Project-LocalProcessing/Step3/awakeRefSpon/GroupSLM17-Oct-2025/1/deltaFSLMGroupRes_Win1.csv");

...
ops0.toolbox_path = 'C:\Work\Analysis\Suite2P-master_online-main';
...
ops0.diameter               = 12; % (12) most important parameter. Set here, or individually per experiment in make_db file
...
ops0.sensorTau              = 1.5; % decay half-life (or timescale). Approximate, for initialization of deconvolution kernel.

     ...
     for iLaser=1:length(LaserG)
            % for iLaser=1:8
                ...
                if length(I3)>=TrialRepTh
                   ...
                   HeatMap{jCell}{iLaser}=permute(tempHeatMap,[2 1 3]);
      ...
      papersizePX=[0 0 2*8 length(LaserG)*8 ];
      set(gcf, 'PaperUnits', 'centimeters');
      set(gcf,'PaperPosition',papersizePX,'PaperSize',papersizePX(3:4));
      saveas(gcf,[ResultFolderCell 'SLMTargetMarkPointMap' num2str(MarkPoint(jCell))],'png');
     close all

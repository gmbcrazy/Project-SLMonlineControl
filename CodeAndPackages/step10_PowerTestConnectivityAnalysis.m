...
[~, ~, ~, cellBoundary, ~] = Suite2pCellIDMapFromStat(CaData.statCell, [confSet.SLM_Pixels_Y confSet.SLM_Pixels_X]);
...
ExampleCell=find(TargetOutDeg<=50&abs(TargetOutMinStrength)>0.01&SuccAmp(:)>0.2);

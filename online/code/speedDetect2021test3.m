...
function [fTrial, fTrialSpeed] = speedDetect2021test3(processedDir, excelfilename, rowsOfInterest)
processedDir        = 'E:\Hari\11232022\statest\';
...
cell_Provalue_thr=cell_Provalue(find(cell_Provalue<0.01));

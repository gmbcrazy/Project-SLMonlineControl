function varargout = new_main_testbyHari(varargin)
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @new_main_testbyHari_OpeningFcn, ...
                   'gui_OutputFcn',  @new_main_testbyHari_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function new_main_testbyHari_OpeningFcn(hObject, eventdata, h, varargin)

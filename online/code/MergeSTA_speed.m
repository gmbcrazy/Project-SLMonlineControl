...
function[] = MergeSTA_speed(processedDir, processedDirSuite2P, excelfilename, rowsOfInterest)

% --- Set paths ---
processedDir        = 'C:\Data\Hari\20220708\';%'C:\Data\Hari\statest2\';
%processedDirWhisk   = 'C:\Data\Hari\whisks\';%'C:\Data\Hari\whisks\';
excelfilename       = 'C:\test\2022_VIPSSTSummaryCOPY.xlsx';
processedDirSuite2P = 'C:\Data\Hari\20220708\07082022_1634\suite2p\';% 'C:\Data\Hari\suite2pfinal\';
expType             = 'chronic';
expBatch            = 'chronic';
rowsOfInterest      = [18]; 
...
for m = 1:numel(rowsOfInterest)
    ...
    for plane = 1:numPlanes
        ...
        % --- Append vars ---
        save([currExpVars.folder '\' currExpVars.name], 'iscell', 'redcell', 'F', 'Fneu', 'Fbase', 'deltaFoF', 'spks', 'fR', '-append');
    end
end
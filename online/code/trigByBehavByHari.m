...
function [statsBehSum, statsCaSum, statsCaStarter, rLR] = trigByBehavByHari(currExpVars, baseSave, activity, fR, goodCells, fTrial, fTrialBehav1, fTrialBehav2, ~, groupName, group, paramTrig, starterID)

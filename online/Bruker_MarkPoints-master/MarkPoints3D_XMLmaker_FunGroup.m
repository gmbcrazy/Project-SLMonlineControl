function MarkPoints3D_XMLmaker_FunGroup(GroupPoints,Repetition, UncagingLaserPower, SavePath)
% Lu Zhang, 10/2024, essentially the same as MarkPoints3D_XMLmaker_Group.m
...
SaveName=[SavePath 'Laser' num2str(UncagingLaserPower) 'FunGroup' num2str(iGroup)];

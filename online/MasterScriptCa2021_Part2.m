...
processedDirWhisk   = 'C:\Data\Hari\whisks\';
excelfilename       = 'C:\test\2022_VIPSSTSummaryCOPY.xlsx';
processedDirSuite2P = 'C:\Data\Hari\suite2pfinal\';% 'C:\Data\Hari\suite2pfinal\';
expType             = 'chronic';
expBatch            = 'chronic';
rowsOfInterest      = [17]; % % Exceptions lines 9-21-24-49; CHANGE HERE; BATCH PROCESSING

...
%%calculating the interpolation from the mid points
% LUTxFH = linspace(ScanAmp_V_FOV_X(1), 0, FOVsize_PX/2);
% LUTxSH = linspace(0,ScanAmp_V_FOV_X(2), FOVsize_PX/2);
% LUTx=[LUTxFH LUTxSH];
% 
% LUTyFH = linspace(ScanAmp_V_FOV_Y(1), 0, FOVsize_PX/2);
% LUTySH = linspace(0,ScanAmp_V_FOV_Y(2), FOVsize_PX/2);
% LUTy=[LUTyFH LUTySH];
%%
...
SpiralSizeV = SpiralSizeUM * (2*ScanAmp_V_FOV_X / (FOVsize_PX));

...
ops.mimg1 = permute(ops.mimg1 / totframes,[2 1]);%change by Hari;original permute(ops.mimg1 / totframes,[2 1]);
mov = permute(mov(:, :, 1:ix),[2 1 3]);%change by Hari;original permute(mov(:, :, 1:ix),[2 1 3])

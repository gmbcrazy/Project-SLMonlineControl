clear all
ProcessFolder='F:\LuSLMOnlineTest\MouseMei03\04292024\All\';
...
SessInfo=readtable('F:\LuSLMOnlineTest\MouseMei03\04292024\SessionInformation.xlsx')
[~,I1,I2]=intersect(Session,SessInfo.Session);
SessInfoNeed=SessInfo(I2,:);
LastFrame=cumsum(SessInfoNeed.Repetitions);
FirstFrame=[1;LastFrame(1:end-1)+1];

Fall=load('F:\LuSLMOnlineTest\MouseMei03\04292024\All\suite2p\combined\Fall.mat');
...
for i=1:length(FirstFrame)
    IndStart(i,1)=FirstFrame(i)-1-PreImgN;

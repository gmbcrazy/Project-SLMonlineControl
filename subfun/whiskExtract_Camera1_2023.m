...
function whiskExtract_Camera1_2023(processedDirWhisk, excelfilename, rowsOfInterest)
...
for m = 1:numel(rowsOfInterest)
    ...
    for t = 1:length(totalFiles)
        
        whiskTrialCurr = totalFiles(t);

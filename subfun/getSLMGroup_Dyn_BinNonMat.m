function [PSTHall, OutTBLAll] = getSLMGroup_Dyn_BinNonMat(folderPath, confSet, PSTHparam, FunGroupPos3D, idRanges)
...
for iCount = 1:length(FileGenerateInfo)
    ...
    PSTHmap = CalMultiPSTHBin_Dyn(FileGenerateInfo(iCount).binFile, confSet, ...
                              indexVector, stimulusIDVector, prePostStimuliVector,PSTHparam.FrameStep);

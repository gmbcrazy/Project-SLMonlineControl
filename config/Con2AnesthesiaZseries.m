...
SLMZeroStimPro=0.16;%Probability that SLM stimuli is with Zero Power ;<<--------------------------------------------------------Edited to adjust current experiment setting
...
save([SaveFolder 'Anesthesia' num2str(SequenceN) 'T_Z' num2str(ZNum) 'Frame' num2str(FrameN) '-' date '.mat']);
